...
export const translations = {
  ru: {
    ...
    telegramConnectDesc: 'Подключите Telegram бота для получения мгновенных уведомлений в ЛС и Telegram-группы при ошибках сервисов.',
    ...
    grantedAccess: 'Предоставленный доступ',
    sharedWithMe: 'Доступные мне',
    selectScope: 'Область доступа',
    allEndpoints: 'Все мои эндпоинты',
    specificEndpoint: 'Конкретный эндпоинт',
    selectRole: 'Роль',
    roleViewer: 'Наблюдатель (только чтение)',
    roleEditor: 'Редактор (чтение и редактирование)',
    expirePeriod: 'Срок действия',
    expireNever: 'Бессрочно',
    expire24h: '24 часа',
    expire7d: '7 дней',
    allowTgNotifications: 'Разрешить уведомления в Telegram-бот',
    allowTgNotificationsHint: 'Пользователи, принявшие ссылку, будут получать уведомления при сбоях и видеть эндпоинты по команде /status',
    generateLinkBtn: 'Сгенерировать ссылку',
    copyLink: 'Скопировать ссылку',
    linkCopied: 'Ссылка скопирована!',
    revoke: 'Отозвать',
    leaveAccess: 'Покинуть',
    sharedBy: 'Общий от {name}',
    acceptInviteTitle: 'Приглашение к мониторингу',
    acceptInviteDesc: '{inviter} приглашает вас получить доступ к мониторингу URL ({endpoint}).',
    acceptInviteBtn: 'Принять приглашение',
    inviteAccepted: 'Вы успешно приняли приглашение!',
    invalidInvite: 'Ссылка-приглашение недействительна или истёк её срок действия',
    noActiveLinks: 'Нет созданных ссылок',
    noGrantedAccess: 'Никому не предоставили доступ',
    noSharedWithMe: 'Нет предоставленного доступа',
  },
  en: {
    // Auth & Login
    loginTitle: 'HealthChecker',
    ...
    telegramConnectDesc: 'Connect Telegram bot to get instant notifications in DM and Telegram groups when service errors occur.',
    ...
    selectScope: 'Access Scope',
    allEndpoints: 'All my endpoints',
    specificEndpoint: 'Specific endpoint',
    selectRole: 'Role',
    roleViewer: 'Viewer (Read-only)',
    roleEditor: 'Editor (Read & Edit)',
    expirePeriod: 'Expiry Period',
    expireNever: 'No expiration',
    expire24h: '24 hours',
    expire7d: '7 days',
    allowTgNotifications: 'Allow Telegram bot notifications',
    allowTgNotificationsHint: 'Users who accept this link will receive failure alerts and see endpoints in the Telegram /status command list',
    ...
    acceptInviteTitle: 'Monitoring Invitation',
    acceptInviteDesc: '{inviter} invites you to get access to URL monitoring ({endpoint}).',
    acceptInviteBtn: 'Accept Invitation',
    inviteAccepted: 'Invitation accepted successfully!',
    invalidInvite: 'Invitation link is invalid or expired',
    noActiveLinks: 'No active invite links',
    noGrantedAccess: 'No access granted yet',
    noSharedWithMe: 'No shared access granted to you yet',
  }
